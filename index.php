...
<head>
  <style>
.chakra-ui-light{
  background-image: url("https://pic.imgdb.cn/item/63fca724f144a0100734f505.webp") !important;
...
<!-- 随机切换模型材质 -->
<script src="https://jsd.cdn.zzko.cn/gh/cooliceycold/live@latest/jsdelivr/random/autoload.js"></script>

<!-- 看板娘位置靠左 -->
<link
  rel="stylesheet"
  href="https://jsd.cdn.zzko.cn/gh/cooliceycold/live@latest/css/left.css"
/>
...
.navbar-brand{cursor: url(/cursor/miku2.png), default;}
</style>
	<nav class="navbar navbar-expand-sm touming navbar-dark mikup">
		<div class="container">
			<a class="navbar-brand" href="./"><img src="https://pic.imgdb.cn/item/626df1b9239250f7c5799187.png" class="img-fluid rounded logo-img mr-2" alt="LOGO" /> IceyDownload</a>
...
<p align="center">访问量统计自 2023.10.9开始</p>
<p align="center"><img src="https://icelink.cf/get/@:jiojio.cf?theme=gelbooru-h" alt=":icelist.cf" />
</p>
