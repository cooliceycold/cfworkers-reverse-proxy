 ...
 * @link https://github.com/yuantuo666/IceyDownload
 */
session_start();
define('init', true);
		...
		<div class="row justify-content-center">
			<?php if (!$is_login) { ?>
				...
				<div class="col-lg-6 col-md-9 mx-auto my-5 input-card">
					<div class="card">
						<div class="card-header bg-dark text-light">IceyDownload - 后台登录</div>
						<div class="card-body">
					...
					<?php if ($method == "analyse") { ?>
						<nav>
							<ol class="breadcrumb my-4">
								<li class="breadcrumb-item"><a href="index.php">IceyDownload</a></li>
